...
OpenSource Globalizer AI 通过自动化以下内容，帮助**开源维护者构建真正的全球社区**：

- 📖 **README / 文档翻译** — 通过 goldmark AST 在 10+ 种语言中保留 Markdown 结构
- 🔄 **GitHub Action 集成** — 推送时自动翻译，自动打开 PR
...
但大多数维护者无法手动翻译每份 README、每个 Issue、每条发布说明。

> **OpenSource Globalizer AI 将本地化工作量从数小时降至数秒。**
