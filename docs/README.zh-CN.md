...
全部由 AI 驱动，并集成到你正在使用的 GitHub 工作流中。

---

## 为什么？

开源天然具有全球性。你的用户使用中文、日本語、한국어、Español、Français、Deutsch……但大多数维护者无法手动翻译每一份 README、每一个 Issue、每一条发布说明。
...
| 🌐 **HTTP API** | v0.1 | ✅ 已发布 | 基于 Gin 的 REST API，支持 POST /api/v1/translate |
